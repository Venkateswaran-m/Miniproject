...
public class OpportunityController {
	...
	public String addOpportunity(@RequestBody Opportunity opportunity)throws ResourceNotFoundException {
	...
	@GetMapping("/users")
	String checkUser(@RequestHeader("Authorization") String token)throws ResourceNotFoundException {
		return opportunityService.checkUser(token);
	}

	@GetMapping(path = "/all")
	public @ResponseBody List<Opportunity> getAlOpportunities(@RequestHeader("Authorization") String token) throws ResourceNotFoundException{
	...
	public List<Opportunity> deleteOpportunity(@PathVariable Integer Id, @RequestHeader("Authorization") String token) throws ResourceNotFoundException {
	...
	public String updateOpportunity(@RequestBody Opportunity o, @RequestHeader("Authorization") String token) throws ResourceNotFoundException{
		if (opportunityService.checkUser(token) == "Login successful") {
	...
	public List<LocationCount> getLocationCount(@RequestHeader("Authorization") String token) throws ResourceNotFoundException{
		if (opportunityService.checkUser(token) == "Login successful") {
